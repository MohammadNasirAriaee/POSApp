...
<template>
    <div
        class="min-h-screen bg-surface-50 flex flex-col md:flex-row font-sans text-surface-800"
    >
        <!-- Mobile Header -->
        <div
            class="md:hidden bg-surface-900 text-white p-4 flex items-center justify-between z-20"
        >
        ...
        >
            <div class="p-6 hidden md:block">
                <span
                    class="font-black text-2xl tracking-tight text-white flex items-center gap-2"
                >
                    <span
                        class="w-8 h-8 rounded-lg bg-primary-600 flex items-center justify-center text-sm"
                        >✦</span
                    >
                    {{ appName }}
                </span>
            ...
            <div class="p-4 border-t border-surface-800">
                ...
                >
                    <div
                        class="w-8 h-8 rounded-full bg-surface-700 flex items-center justify-center"
                    >
            ...
            >
                ...
                <div class="flex items-center gap-4">
                    ...
                    >
                        <Bell class="w-5 h-5" />
                        <span
                            class="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-rose-500 border-2 border-white"
                        ></span>
                    </button>
                </div>
            </header>
        ...
        <div
            ...
            class="fixed inset-0 bg-surface-900/50 backdrop-blur-sm z-0 md:hidden"
        ></div>
    </div>
</template>
