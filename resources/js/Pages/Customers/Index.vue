        ...
        <Card>
            <template #header>
                <div class="relative w-full max-w-sm">
                    ...
                    />
                    <button v-if="searchQuery" @click="clearSearch" aria-label="Clear customer search" class="absolute inset-y-0 right-0 flex items-center pr-3 text-surface-400 hover:text-surface-600">
                        <X class="w-4 h-4" />
                    </button>
                </div>
            </template>
